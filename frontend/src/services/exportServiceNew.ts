...
export async function exportSummaryToWord(
  ...
  logger.debug('Début de la fonction exportSummaryToWord (nouvelle version) avec:', {
  ...
  try {
    ...
    logger.debug('Document Word généré avec succès');
    ...
    logger.debug('Téléchargement du fichier:', fileName);
