...
export async function exportSummaryToWord(
  ...
  logger.debug('Début de la fonction exportSummaryToWord avec:', {
  ...
  logger.debug('Génération du document Word...');
  // Générer le document Word
  const buffer = await Packer.toBuffer(doc);
  logger.debug('Document Word généré avec succès, taille du buffer:', buffer.byteLength);
