...
export async function exportSummaryToWord(
  ...
  logger.debug('Début de la fonction exportSummaryToWord (version simple) avec:', {
  ...
  try {
    ...
    logger.debug('Téléchargement du fichier HTML:', fileName);
    saveAs(blob, fileName);
    logger.debug('Fichier HTML téléchargé avec succès');
