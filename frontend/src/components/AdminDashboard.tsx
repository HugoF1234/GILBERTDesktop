    ...
    return (
      <div className="min-h-screen bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="h-10 w-72 rounded-lg bg-slate-200 animate-pulse mb-2" />
          <div className="h-4 w-96 rounded bg-slate-200 animate-pulse mb-8" />
          ...
          <div className="rounded-lg border border-slate-200 p-6">
            <div className="h-6 w-48 rounded bg-slate-200 animate-pulse mb-4" />
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
                                  ...
                                  >
                                    ...
                                    <p className="text-xs text-emerald-600">Engagement 12 mois</p>
                                  </button>
                                  <button
                                    type="button"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  ...
                  <p className="text-xs text-slate-500">19,90€/mois (12 mois)</p>
                </button>
                <button
                  onClick={() => setSubscriptionPlan('enterprise')}
                  className={cn(
